...
public class CheckSellPrepayManager : MonoBehaviour
{
    ...
    public Text monthRemainTxt;
    public Text prepayPriceTxt;
    public Text usagePriceTxt;
    public Text delPriceTxt;
    public Text lastRemainPriceTxt;
    public Text delExpiredTagTxt;
    public Text managerDelTxt;
    public Text totalDelPriceTxt;
    public Text chargeRemainTxt;
    public Text prepayRemainTxt;
    ...
    void SendRequest()
    {
        ...
        form.AddField("pub_id", Global.userinfo.pub.id);
        WWW www = new WWW(Global.api_url + Global.get_sellprepay_api, form);
    ...
    IEnumerator GetDayInfo(WWW www)
    {
        ...
        if (www.error == null)
        {
            ...
            {
                monthRemainTxt.text = Global.GetPriceFormat(jsonNode["monthRemain"].AsInt);
                prepayPriceTxt.text = Global.GetPriceFormat(jsonNode["prepayPrice"].AsInt);
                usagePriceTxt.text = Global.GetPriceFormat(jsonNode["usagePrice"].AsInt);
                delPriceTxt.text = Global.GetPriceFormat(jsonNode["delPrice"].AsInt);
                lastRemainPriceTxt.text = Global.GetPriceFormat(jsonNode["lastRemainPrice"].AsInt);
                delExpiredTagTxt.text = Global.GetPriceFormat(jsonNode["delExpiredTag"].AsInt);
                managerDelTxt.text = Global.GetPriceFormat(jsonNode["managerDel"].AsInt);
                totalDelPriceTxt.text = Global.GetPriceFormat(jsonNode["totalDelPrice"].AsInt);
                chargeRemainTxt.text = Global.GetPriceFormat(jsonNode["chargeRemain"].AsInt);
                prepayRemainTxt.text = Global.GetPriceFormat(jsonNode["prepayRemain"].AsInt);
            }
            else
            {
                err_str.text = "매출조회에 실패하였습니다.";
                err_popup.SetActive(true);
            }
        }
    }
