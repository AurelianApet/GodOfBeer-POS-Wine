...
public class splash : MonoBehaviour
{
    ...
    {
#if UNITY_IPHONE
		Global.imgPath = Application.persistentDataPath + "/wpos_img/";
#elif UNITY_ANDROID
        Global.imgPath = Application.persistentDataPath + "/wpos_img/";
#else
if( Application.isEditor == true ){ 
        ...
        if(Global.setinfo.printerSet.printer1.name == null || Global.setinfo.printerSet.printer1.name == "")
        {
            Global.setinfo.printerSet.printer1.name = "주방1";
        }
        Global.setinfo.printerSet.printer2.name = PlayerPrefs.GetString("printer2name");
        if (Global.setinfo.printerSet.printer2.name == null || Global.setinfo.printerSet.printer2.name == "")
        {
            Global.setinfo.printerSet.printer2.name = "주방2";
        }
        Global.setinfo.printerSet.printer3.name = PlayerPrefs.GetString("printer3name");
        if (Global.setinfo.printerSet.printer3.name == null || Global.setinfo.printerSet.printer3.name == "")
        {
            Global.setinfo.printerSet.printer3.name = "주방3";
        }
        Global.setinfo.printerSet.printer4.name = PlayerPrefs.GetString("printer4name");
        if (Global.setinfo.printerSet.printer4.name == null || Global.setinfo.printerSet.printer4.name == "")
        {
            Global.setinfo.printerSet.printer4.name = "주방4";
        }
